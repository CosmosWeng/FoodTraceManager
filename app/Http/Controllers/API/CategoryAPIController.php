...
class CategoryAPIController extends AppBaseController
{
    ...
    public function getProducts($id, Request $request)
    {
        ...
        $products = $category->products()->paginate($request->get('limit', null));

        return $this->sendPaginateResponse($products->toArray(), 'Products retrieved successfully By Categories');
    }
